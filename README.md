...
4. Model selection: In this phase, we will use the metric or set of metrics chosen in the previous phase to choose the best model. We trained different models with all the hyperparameter configurations and we helped us with differents graphics to visualize the performance of the model.
